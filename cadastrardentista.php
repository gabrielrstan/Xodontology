...
function formatar(mascara, documento)
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      ...
      <!--<div class="jumbotron">
        ...
        <center><h1><b><br>Cadastro de Dentistas</b></h1></center>
      </div>
        ...
        <form class="form-horizontal" action="enviardentista.php" method="post" name="form1">
			<fieldset>
			...
			<div class="form-group">
			  ...
			  <div class="col-md-8">
                  <div class="input-group">
			  <input id="salario" name="salario" type="number" placeholder="Digite aqui o salário" class="form-control input-md" required="">
