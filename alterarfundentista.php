...
<html lang="pt-br">
  ...
  <body role="document">
    ...
    <div class="container theme-showcase" role="main">
		...
		<center><h1><b><br>Funcionarios</b></h1></center>
		</div>
        
        <div class="alert alert-info" role="alert">
      <center><strong>Mudança</strong> <br>Para realizar a mudança em algum dos dados, basta digitar e clicar em "Guardar". <br></center>
    </div>
        ...
        <table class="table table-striped">
          <thead>
            ...
            <tbody>
		<?php
        $sql = "SELECT fun_nome, fun_telefone, fun_email, fun_endereco, fun_cpf, fun_salario FROM tb_funcionario";
                ...
                $cpf=$linha["fun_cpf"];
                $salario=$linha["fun_salario"];

				

        
        ?>
                <form class="" action="alterarfundentista2.php" method="post" name="form1">
                <tr>
