...
<html lang="pt-br">
  ...
  <body role="document">
    ...
    <div class="container theme-showcase" role="main">
		...
		<center><h1><b><br>Cancelar Consulta</b></h1></center>
		</div>
        
        <div class="alert alert-info" role="alert">
      <center><strong>Cancelamento</strong> <br>Para cancelar uma consulta basta escolhar qual e confirmar o cancelamento.</center>
    </div>
        ...
        <table class="table table-striped">
          <thead>
            ...
            <?php
        $sql = "SELECT con_codigo,con_data, con_hora, con_dentista,con_pa_cpf,con_paciente FROM tb_consulta
            where con_data > sysdate()  ";
                ...
                $codigo=$linha["con_codigo"];
                $paciente=$linha["con_paciente"];

				$hora=str_replace(":00.000000","",$hora);

        
        ?>
                <form class="" action="cancelarconsultafuncionario2.php" method="post" name="form1">
                <tr>
