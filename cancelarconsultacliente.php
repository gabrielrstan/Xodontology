      ...
      <center><strong>Cancelamento</strong> <br>Para cancelar uma consulta basta escolhar qual e confirmar o cancelamento.</center>
        ...
        <table class="table table-striped">
          <thead>
            ...
            <?php
        $sql = "SELECT con_codigo,con_data, con_hora, con_dentista,con_pa_cpf FROM tb_consulta
        ...
        ?>
                ...
                <tr>
                    ...
                    <td><center><button type="submit" class="btn btn-danger" >Cancelar</button></center></td>
