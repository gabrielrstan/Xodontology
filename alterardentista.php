      ...
      <center><strong>Mudança</strong> <br>Para realizar a mudança em algum dos seus dados, basta digitar e clicar em "Guardar". <br>O sistema lhe mandará um e-mail e com o código que virá, você poderá efetuar as mudanças que desejar.</center>
        ...
        <table class="table table-striped">
          <thead>
            ...
            <?php
        $sql = "SELECT den_codigo, den_nome, den_senha, den_telefone, den_email, den_endereco, den_complemento, den_bairro, den_cidade, den_cpf, den_rg FROM tb_dentista WHERE den_codigo = " .$_SESSION['id'];
        ...
        ?>
            <tbody>
                <form class="" action="alterardentista2.php" method="post" name="form1">
                <tr>
