...
<div class="container theme-showcase" role="main">
		...
		<center><h1><b><br>Pagamentos</b></h1></center>
		</div>
        
        <div class="alert alert-info" role="alert">
      <center><strong>Pagar</strong> <br>Aqui você inclui os pagamentos recebidos.</center>
    </div>
    <div class="page-header">
        <form class="form-horizontal" action="enviarpagamentofun.php" method="post" name="form1">
                    
            <div class="form-row">
                
                <div class="col-md-3">
             
			  <label class="control-label" for="data">Escolha a Data do Pagamento</label>  
			  <input id="data" name="data" type="date" placeholder="" class="form-control input-md" required="">
				
        </div>
    
    <div class="col-md-2">
			  <label class="control-label" for="nascimento">Escolha o Valor </label>  
			  <input id="valor" name="valor" type="number" placeholder="" class="form-control input-md" required="">
			</div>
                <div class="col-md-4">
			  <label class="control-label" for="nascimento">Detalhes </label>  
			  <input id="detalhes" name="detalhes" type="text" placeholder="" class="form-control input-md" required="">
			</div>
