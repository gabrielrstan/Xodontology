...
function formatar(mascara, documento)
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      ...
      <!--<div class="jumbotron">
        ...
        <center><h1><b><br>Cadastro de Funcionarios</b></h1></center>
      </div>
        ...
        <form class="form-horizontal" action="enviarfuncionario.php" method="post" name="form1">
			<fieldset>
			...
			<div class="form-group">
			  ...
			  <div class="col-md-8">
				<div class="input-group">
				  <input id="telefone" name="text" class="form-control" placeholder="Digite seu telefone" type="text">
			...
			<div class="form-group">
			  ...
			  <input id="email" name="email" type="email" placeholder="Digite aqui seu E-Mail" class="form-control input-md" required="">
                  ...
                  <!-- Text input-->
			<div class="form-group">
			  <label class="col-md-4 control-label" for="rg">Salario</label>  
			  <div class="col-md-8">
                  <div class="input-group">
			  <input id="rg" name="rg" type="number" placeholder="Digite aqui o salário" class="form-control input-md" required="">
