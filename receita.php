...
<div class="container theme-showcase" role="main">
		...
		<center><h1><b><br>Receitas</b></h1></center>
		</div>
        
        <div class="alert alert-info" role="alert">
      <center><strong>Gerar Receitas</strong> <br>Aqui você gera as receitas para seus pacientes.</center>
    </div>
    <div class="page-header">
        <form class="form-horizontal" action="enviareceita.php" method="post" name="form1">
...
<div class="form-group">
            ...
            <div class="form-group">
			  <label class="col-md-4 control-label" for="detalhes">Receita </label>
                <div class="col-md-4">
			  <textarea rows="4" cols="60" class="form-control" name="prescricao" placeholder="Prescricao" style="resize: vertical" required></textarea>
            </div>
