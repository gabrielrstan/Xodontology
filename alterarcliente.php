      ...
      <center><strong>Mudança</strong> <br>Para realizar a mudança em algum dos seus dados, basta digitar e clicar em "Guardar". <br>O sistema lhe mandará um e-mail e com o código que virá, você poderá efetuar as mudanças que desejar.</center>
        ...
        <table class="table table-striped">
          <thead>
            ...
            <?php
        $sql = "SELECT pa_codigo, pa_nome, pa_senha, pa_telefone, pa_email, pa_endereco, pa_complemento, pa_bairro, pa_cidade, pa_cpf, pa_rg FROM tb_paciente WHERE pa_codigo = " .$_SESSION['id'];
        ...
        ?>
            <tbody>
                <form class="" action="alterarcliente2.php" method="post" name="form1">
                <tr>
